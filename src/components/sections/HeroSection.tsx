...
const socialLinks = [
  {
    icon: FileText,
    href: "https://www.canva.com/design/DAG-GM17ks0/pMDkHbJecxXC5WZOOUTDbA/view",
    label: "Resume",
  },
  { icon: Github, href: "https://github.com/phoo3011", label: "GitHub" },
  {
    icon: Linkedin,
    href: "https://www.linkedin.com/in/phoo3011/",
    label: "LinkedIn",
  },
  {
    icon: DevfolioIcon,
    href: "https://devfolio.co/@phoo3011",
    label: "Devfolio",
  },
];
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            ...
            >
              ...
              <span className="text-sm text-muted-foreground font-merriweather">
                Chiang Mai, Thailand
              </span>
            </motion.div>
