      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-lg text-muted-foreground leading-relaxed mb-6 font-sfpro">
            ...
            <div className="grid grid-cols-3 gap-6">
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  <div className="text-xs text-muted-foreground uppercase tracking-wider font-merriweather">
                    {stat.label}
                  </div>
                </motion.div>
              ))}
          ...
          >
            {highlights.map((item, index) => (
              ...
              >
                ...
                <h4 className="text-xl font-semibold font-marcellus">{item.title}</h4>
